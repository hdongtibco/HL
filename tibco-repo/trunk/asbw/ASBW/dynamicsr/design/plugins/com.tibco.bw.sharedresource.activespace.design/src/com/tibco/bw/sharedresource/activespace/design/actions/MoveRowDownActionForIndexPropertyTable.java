...
public class MoveRowDownActionForIndexPropertyTable extends TableWithButtonsMoveRowDownAction{
	private StructuredViewer viewer;
	
	public MoveRowDownActionForIndexPropertyTable(StructuredViewer viewer, String text) {
		super(viewer, text);
		this.viewer = viewer;
	}
