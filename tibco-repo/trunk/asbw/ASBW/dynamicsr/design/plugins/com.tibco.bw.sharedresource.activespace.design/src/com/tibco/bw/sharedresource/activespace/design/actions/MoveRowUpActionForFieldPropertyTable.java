...
public class MoveRowUpActionForFieldPropertyTable extends TableWithButtonsMoveRowUpAction{
	private StructuredViewer viewer;
	public MoveRowUpActionForFieldPropertyTable(StructuredViewer viewer, String text) {
		super(viewer, text);
		this.viewer = viewer;
	}
