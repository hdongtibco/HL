...
public class ASMetadataUtils {
	 ...
	 * @throws Exception
	 */
	public static void defineSpace(ASMetadata metaData, Metaspace ms, Collection<FieldDef> fieldDefs,Collection<IndexDef> indexDefs, Collection<KeyDef> keyDefs, Map<String, String> spaceDefProertyMap , String distributionFields) throws Exception {
		...
		//Add affinityDef 
		if (null != distributionFields && !"".equals(distributionFields)) {
		    String[] distributionFieldsArray = distributionFields.split(":");
		    ((SpaceDef)spaceDefInstance).setDistributionFields(distributionFieldsArray);
		}
