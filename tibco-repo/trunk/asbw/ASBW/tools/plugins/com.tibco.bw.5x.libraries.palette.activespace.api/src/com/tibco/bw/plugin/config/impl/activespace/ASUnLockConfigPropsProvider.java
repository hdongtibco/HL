...
import com.tibco.bw.plugin.config.activespace.ASUnLockConfigProps;
...
public class ASUnLockConfigPropsProvider extends DefaultConfigPropsProvider
		implements ASUnLockConfigProps, ASExpandedNameConstants {

	public ASUnLockConfigPropsProvider(
