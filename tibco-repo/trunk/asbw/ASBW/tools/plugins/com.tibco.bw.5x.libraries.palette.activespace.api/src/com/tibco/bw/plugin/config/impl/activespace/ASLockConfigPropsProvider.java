...
import com.tibco.bw.plugin.config.activespace.ASLockConfigProps;
...
public class ASLockConfigPropsProvider extends DefaultConfigPropsProvider
		implements ASLockConfigProps, ASExpandedNameConstants {

	public ASLockConfigPropsProvider(ActivityDescriptor paramActivityDescriptor) {
