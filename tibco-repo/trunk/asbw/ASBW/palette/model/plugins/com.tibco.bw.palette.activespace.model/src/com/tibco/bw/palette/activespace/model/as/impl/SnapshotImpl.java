 ...
 * <ul>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.SnapshotImpl#getSpaceConnection <em>Space Connection</em>}</li>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.SnapshotImpl#getDistributionScope <em>Distribution Scope</em>}</li>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.SnapshotImpl#getBrowserType <em>Browser Type</em>}</li>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.SnapshotImpl#getPrefetch <em>Prefetch</em>}</li>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.SnapshotImpl#getTimeScope <em>Time Scope</em>}</li>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.SnapshotImpl#getQueryLimit <em>Query Limit</em>}</li>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.SnapshotImpl#getTimeout <em>Timeout</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SnapshotImpl extends EObjectImpl implements Snapshot {
	...
	protected EClass eStaticClass() {
		return AsPackage.Literals.SNAPSHOT;
	}
	...
	public void setSpaceConnection(String newSpaceConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.SNAPSHOT__SPACE_CONNECTION, oldSpaceConnection, spaceConnection));
	}
	...
	public void setDistributionScope(String newDistributionScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.SNAPSHOT__DISTRIBUTION_SCOPE, oldDistributionScope, distributionScope));
	}
	...
	public void setBrowserType(String newBrowserType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.SNAPSHOT__BROWSER_TYPE, oldBrowserType, browserType));
	}
	...
	public void setPrefetch(String newPrefetch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.SNAPSHOT__PREFETCH, oldPrefetch, prefetch));
	}
	...
	public void setTimeScope(String newTimeScope) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.SNAPSHOT__TIME_SCOPE, oldTimeScope, timeScope));
	}
	...
	public void setQueryLimit(String newQueryLimit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.SNAPSHOT__QUERY_LIMIT, oldQueryLimit, queryLimit));
	}
	...
	public void setTimeout(String newTimeout) {
		...
		timeout = newTimeout;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.SNAPSHOT__TIMEOUT, oldTimeout, timeout));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AsPackage.SNAPSHOT__SPACE_CONNECTION:
				return getSpaceConnection();
			case AsPackage.SNAPSHOT__DISTRIBUTION_SCOPE:
				return getDistributionScope();
			case AsPackage.SNAPSHOT__BROWSER_TYPE:
				return getBrowserType();
			case AsPackage.SNAPSHOT__PREFETCH:
				return getPrefetch();
			case AsPackage.SNAPSHOT__TIME_SCOPE:
				return getTimeScope();
			case AsPackage.SNAPSHOT__QUERY_LIMIT:
				return getQueryLimit();
			case AsPackage.SNAPSHOT__TIMEOUT:
				return getTimeout();
		}
