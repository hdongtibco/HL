 ...
 * <ul>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.CommitTransactionImpl#getMetaspace <em>Metaspace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CommitTransactionImpl extends EObjectImpl implements CommitTransaction {
	/**
	...
	protected EClass eStaticClass() {
		return AsPackage.Literals.COMMIT_TRANSACTION;
	}
	...
	public void setMetaspace(String newMetaspace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.COMMIT_TRANSACTION__METASPACE, oldMetaspace, metaspace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AsPackage.COMMIT_TRANSACTION__METASPACE:
				return getMetaspace();
		}
