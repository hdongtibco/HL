...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Begin Transaction</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.BeginTransactionImpl#getMetaspace <em>Metaspace</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BeginTransactionImpl extends EObjectImpl implements BeginTransaction {
	/**
	 ...
	 * @generated
	 */
	protected BeginTransactionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AsPackage.Literals.BEGIN_TRANSACTION;
	}
	...
	public void setMetaspace(String newMetaspace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.BEGIN_TRANSACTION__METASPACE, oldMetaspace, metaspace));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AsPackage.BEGIN_TRANSACTION__METASPACE:
				return getMetaspace();
		}
