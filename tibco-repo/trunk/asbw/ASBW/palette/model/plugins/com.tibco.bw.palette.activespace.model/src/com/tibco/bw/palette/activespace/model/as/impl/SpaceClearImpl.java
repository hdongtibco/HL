...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Space Clear</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.tibco.bw.palette.activespace.model.as.impl.SpaceClearImpl#getSpaceConnection <em>Space Connection</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SpaceClearImpl extends EObjectImpl implements SpaceClear {
	/**
	...
	protected EClass eStaticClass() {
		return AsPackage.Literals.SPACE_CLEAR;
	}
	...
	public void setSpaceConnection(String newSpaceConnection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsPackage.SPACE_CLEAR__SPACE_CONNECTION, oldSpaceConnection, spaceConnection));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AsPackage.SPACE_CLEAR__SPACE_CONNECTION:
