...
public class ClarityConnectionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ClarityConnectionPackage.CLARITY_CONNECTION: {
				ClarityConnection clarityConnection = (ClarityConnection)theEObject;
				T result = caseClarityConnection(clarityConnection);
				if (result == null) result = caseSubstitutableObject(clarityConnection);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Clarity Connection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Clarity Connection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseClarityConnection(ClarityConnection object) {
		return null;
	}
