...
public class ClarityReloadFileSignature extends ClarityBasicSignature {



    private static final String SCHEMA_INPUT_ROOT_NAME = "reloadfileAllInput";
    
    private   final String SCHEMA_OUTPUT_ROOT_NAME = "reloadfileAllOutput";
	...
	public void constructInputType(XSDModelGroup activityInput,
		 ...
		 XSDModelGroup file= XSDUtility.addComplexTypeElement(activityInput, "File", "File", 1, -1 ,XSDCompositor.SEQUENCE_LITERAL);
