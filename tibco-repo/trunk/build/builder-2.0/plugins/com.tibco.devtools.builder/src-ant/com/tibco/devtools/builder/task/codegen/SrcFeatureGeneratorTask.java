...
import com.tibco.devtools.builder.codegen.SourceFeatureGenerator;

public class SrcFeatureGeneratorTask
    extends Task
{
        ...
        throws BuildException
    {
        ...
        try
        {
            SourceFeatureGenerator generator = new SourceFeatureGenerator(m_ruLocation);
            generator.generate();
        }
        catch (Exception e)
        {
